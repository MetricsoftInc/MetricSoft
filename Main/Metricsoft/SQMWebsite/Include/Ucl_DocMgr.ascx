 ...
 <script type="text/javascript">
   ...
   <telerik:RadAjaxPanel runat="server" ID="pnlSelectDocument" Visible=false>
        <span>
            ...
            <telerik:RadComboBox ID="ddlSelectDocs" runat="server" ZIndex=9000 Width=240 DropDownCssClass="multipleRowsColumns" DropDownWidth="560px" Skin="Metro"  EmptyMessage="Application References" AutoPostBack="false"  OnClientSelectedIndexChanged="DisplayDocument"></telerik:RadComboBox>
        </span>
