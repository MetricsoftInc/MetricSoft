                ...
                <div style="float: left; margin: 5px; height: 30px;">
                    <table cellspacing=0 cellpadding=2 border=0 width="100%">
                        <tr>
                            ...
                            <td>
                                <telerik:RadComboBox ID="ddlScheduleScope" runat="server" Skin="Metro" Width=280 ZIndex=9000 Font-Size=Small 
                                ...
                                <telerik:RadMenu ID="mnuScheduleScope" runat="server" Skin="Default" Width=280 style="z-index: 2900;" EnableAutoScroll="true"  DefaultGroupSettings-Flow="Vertical" DefaultGroupSettings-RepeatDirection="Horizontal" OnItemClick="ScheduleScope_Select"></telerik:RadMenu>
                            </td>
                            <td>
                                <span class="logoImg noprint">
