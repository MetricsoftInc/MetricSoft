		...
		protected void btnSubnav_Click(object sender, EventArgs e)
		{
			...
			switch (btn.CommandArgument)
			{
				...
				case "60":
					...
					uclVideoPanel.OpenManageVideosWindow((int)TaskRecordType.HealthSafetyIncident, EditIncidentId, "1", Resources.LocalizedText.VideoUpload, Resources.LocalizedText.VideoForIncident, "", rddlInjuryType.SelectedValue, rddlBodyPart.SelectedValue, viewMode, false);
					break;
				case "0":
				default:
					lblFormTitle.Text = Resources.LocalizedText.Incident;
