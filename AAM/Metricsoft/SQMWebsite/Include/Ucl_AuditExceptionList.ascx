...
<asp:Panel ID="pnlAuditListRepeater" runat="server" Visible="False">
	<div>
		...
		<telerik:RadGrid ID="rgAuditList" runat="server" Skin="Metro" AllowSorting="True" AllowPaging="True" PageSize="20"
			...
			<MasterTableView DataKeyNames="Audit.Audit_ID">
				<NestedViewTemplate>
					<telerik:RadGrid runat="server" ID="rgAuditAnswers" OnNeedDataSource="rgAuditAnswers_NeedDataSource" Width="100%" AllowSorting="True" AutoGenerateColumns="False"
						...
						<MasterTableView DataKeyNames="QuestionId" GroupsDefaultExpanded="true">
							<NestedViewTemplate>
								<telerik:RadGrid runat="server" ID="rgTasks" OnNeedDataSource="rgTasks_NeedDataSource" Width="100%" AutoGenerateColumns="False" OnItemDataBound="rgTasks_ItemDataBound" GroupPanelPosition="Top">
									<MasterTableView DataKeyNames="Task.TASK_ID">
										...
										<Columns>
											<telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn column" HeaderText="<%$ Resources:LocalizedText, ResponsiblePerson %>" UniqueName="TemplateColumn" ItemStyle-Width="25%">
												<ItemTemplate>
													<asp:Label ID="lblTaskAssignedTo" runat="server"></asp:Label>
												</ItemTemplate>
											</telerik:GridTemplateColumn>
											<telerik:GridBoundColumn DataField="Task.Due_Dt" DataFormatString="{0:d}" FilterControlAltText="Filter Task.Due_Dt column" HeaderText="<%$ Resources:LocalizedText, DueDate %>" UniqueName="Task.Due_Dt" ItemStyle-Width="10%">
											</telerik:GridBoundColumn>
											<telerik:GridBoundColumn DataField="Task.Description" FilterControlAltText="Filter Task.Description column" HeaderText="<%$ Resources:LocalizedText, Description %>" UniqueName="Task.Description" ItemStyle-Width="25%">
											</telerik:GridBoundColumn>
											<telerik:GridBoundColumn DataField="Taskstatus" FilterControlAltText="Filter Taskstatus column" HeaderText="<%$ Resources:LocalizedText, Status %>" UniqueName="Taskstatus" ItemStyle-Width="5%">
											</telerik:GridBoundColumn>
											<telerik:GridBoundColumn DataField="Task.Comments" FilterControlAltText="Filter Task.Comments column" HeaderText="<%$ Resources:LocalizedText, Comments %>" UniqueName="Task.Comments" ItemStyle-Width="25%">
											</telerik:GridBoundColumn>
											<telerik:GridBoundColumn DataField="Task.Complete_dt" DataFormatString="{0:d}" FilterControlAltText="Filter Task.Complete_dt column" HeaderText="Complete Date" meta:resourcekey="GridBoundColumnResource5" UniqueName="Task.Complete_dt" ItemStyle-Width="10%">
											</telerik:GridBoundColumn>
										</Columns>
									</MasterTableView>
								</telerik:RadGrid>
							...
							<Columns>
								...
								<telerik:GridBoundColumn DataField="TopicTitle" FilterControlAltText="Filter TopicTitle column" HeaderText="Topic" meta:resourcekey="GridBoundColumnResource6" UniqueName="TopicTitle" ItemStyle-Width="10%">
								</telerik:GridBoundColumn>
								<telerik:GridBoundColumn DataField="QuestionText" FilterControlAltText="Filter QuestionText column" HeaderText="<%$ Resources:LocalizedText, Question %>" UniqueName="QuestionText" ItemStyle-Width="10%">
								</telerik:GridBoundColumn>
								<telerik:GridBoundColumn DataField="AnswerText" FilterControlAltText="Filter AnswerText column" HeaderText="Answer" meta:resourcekey="GridBoundColumnResource8" UniqueName="AnswerText" ItemStyle-Width="5%">
								</telerik:GridBoundColumn>
								<telerik:GridBoundColumn DataField="AnswerComment" FilterControlAltText="Filter AnswerComment column" HeaderText="Comment" meta:resourcekey="GridBoundColumnResource9" UniqueName="AnswerComment" ItemStyle-Width="15%">
								</telerik:GridBoundColumn>
								<telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn1 column" HeaderText="<%$ Resources:LocalizedText, Status %>" UniqueName="TemplateColumn1" ItemStyle-Width="10%">
									<ItemTemplate>
										<asp:Label ID="lblAnswerStatus" runat="server"></asp:Label>
									</ItemTemplate>
								</telerik:GridTemplateColumn>
								<telerik:GridBoundColumn DataField="ResolutionComment" FilterControlAltText="Filter ResolutionComment column" HeaderText="Resolution" meta:resourcekey="GridBoundColumnResource10" UniqueName="ResolutionComment" ItemStyle-Width="15%">
								</telerik:GridBoundColumn>
								<telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn2 column" HeaderText="<%$ Resources:LocalizedText, Completed %>" UniqueName="TemplateColumn2" ItemStyle-Width="5%">
									<ItemTemplate>
										<asp:Label ID="lblResolutionDate" runat="server"></asp:Label>
									</ItemTemplate>
								</telerik:GridTemplateColumn>
								<telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn3 column" UniqueName="TemplateColumn3" ItemStyle-Width="10%">
									<ItemTemplate>
								...
								<telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn4 column" UniqueName="TemplateColumn4" ItemStyle-Width="10%">
									<ItemTemplate>
								...
								<telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn5 column" UniqueName="TemplateColumn5" ItemStyle-Width="10%">
									<ItemTemplate>
