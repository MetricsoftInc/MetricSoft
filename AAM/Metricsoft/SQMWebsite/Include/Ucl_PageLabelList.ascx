<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Ucl_PageLabelList.ascx.cs" Inherits="SQM.Website.Ucl_PageLabelList" %>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="admBkgd">
                            ...
                            <tr>
                                ...
                                <td align=right  style="padding-right:40px; margin-top:4px;">
                                    <asp:Button ID="btnSavePageLabels" runat="server" CSSclass="buttonEmphasis" Text="Save and Submit Page Text" OnClientClick="return confirmChange('Page Text');" onclick="btnSavePageLabels_Click"></asp:Button>
                                </td>
                            </tr>
                         </table>
                    </td>
