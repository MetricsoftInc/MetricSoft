...
namespace SQM.Website
{
    public partial class Ucl_EHSIncidentForm : System.Web.UI.UserControl
    {
                ...
                else
                {
                    ...
                    switch (q.QuestionType)
                    {
                        ...
                        case EHSIncidentQuestionType.Date:
                            ...
                            {
                                rdp = new RadDatePicker() { ID = qid, Skin = "Metro", CssClass = "WarnIfChanged", Width = 400 };
                            }
                        ...
                        case EHSIncidentQuestionType.Time:
                            ...
                            {
                                rtp = new RadTimePicker() { ID = qid, Skin = "Metro", CssClass = "WarnIfChanged", Width = 400 };
                            }
        ...
        protected void btnSaveContinue_Click(object sender, EventArgs e)
        {
            ...
            {
                Save(false);
                string script = string.Format("alert('{0}');", "Data saved successfully.");
                ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", script, true);
            }
            else
            {
        ...
        /// <summary>
        /// To add data for Add another timeline section in INCIDENT_TIMELINE_ANSWER Table.
        /// Here we always delete existing records (if available) from table and then add new records into it.
        /// </summary>
        /// <param name="incidentId"></param>
        /// <param name="questions"></param>
        protected void addTimeLine(int incidentId, List<EHSIncidentQuestion> questions)
        {
            var TimePiker = Request.Form.GetValues("TimePiker");
