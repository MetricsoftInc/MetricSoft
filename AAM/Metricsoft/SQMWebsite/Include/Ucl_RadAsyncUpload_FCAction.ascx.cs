...
{
    public partial class Ucl_RadAsyncUpload_FCAction : System.Web.UI.UserControl
    {    public delegate void AttachmentDelete(ATTACHMENT attachment);
        public event AttachmentDelete OnAttachmentDelete;

		public RadAsyncUpload RAUpload1
		{
			get { return raUpload1; }
		}
        ...
        public void SetViewMode(bool visible)
        {
			...
			this.raUpload1.Visible = visible;
		...
		public void SaveFiles()
		{
			...
			int i = 0;
			foreach (UploadedFile file in raUpload1.UploadedFiles)
			{
