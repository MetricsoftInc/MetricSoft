...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Ucl_RadAsyncUpload_FCAction.ascx.cs" Inherits="SQM.Website.Include.Ucl_RadAsyncUpload_FCAction" %>
...
<script type="text/javascript">
    function onClientFileUploadedJS(sender, args) {
		...
		//alert(desc);
	    var radAsyncUpload = $find('<%=raUpload1.ClientID%>');
	    console.log(radAsyncUpload);
...
<table cellpadding="0" cellspacing="0">
	<tr>
		...
		<td>
			<telerik:RadAsyncUpload runat="server" ID="raUpload1" MultipleFileSelection="Disabled" MaxFileInputsCount="10" Localization-Select="Browse..."
