...
<telerik:RadSearchBox ID="rsbPerson" runat="server"  MaxResultCount="400" EnableAutoComplete="false" DataKeyNames="PersonId" Skin="Metro" OnClientSearch="onPersonSearch" OnSearch="OnSearchServer" 
