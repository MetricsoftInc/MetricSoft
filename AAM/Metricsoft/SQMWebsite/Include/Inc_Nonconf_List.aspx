			                                ...
			                                <tr>
			  	                                <td align=right>
					                                <table cellpadding=0 cellspacing=2 border=0>
						                                <tr>
                                                            <td>
                                                                <asp:Button ID="lbSave1" CSSclass="buttonEmphasis" runat="server" text="Save" OnClientClick="return confirmChange('List');" onclick="lbSaveNonconf_Click"></asp:Button>
                                                            </td>
						                                </tr>
					                                </table>
				                                </td>
			                    ...
			                    <tr>
			  	                    <td class="editArea" align=right>
					                    <table cellpadding=0 cellspacing=2 border=0>
						                    <tr>
                                                <td>
                                                    <asp:Button ID="lbSave2" CSSclass="buttonEmphasis" runat="server" text="Save" OnClientClick="return confirmChange('List');" onclick="lbSaveNonconf_Click"></asp:Button>
                                                </td>
						                    </tr>
					                    </table>
				                    </td>
