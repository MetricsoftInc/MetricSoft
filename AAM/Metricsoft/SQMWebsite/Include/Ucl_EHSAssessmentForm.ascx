<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Ucl_EHSAssessmentForm.ascx.cs" Inherits="SQM.Website.Ucl_EHSAssessmentForm" %>
...
<div id="divAuditForm" runat="server" visible="false">
    <div style="width: 100%; text-align: center; margin-bottom: 10px;"><a href="~/EHS/EHS_Assessments.aspx" id="ahReturn" runat="server">
