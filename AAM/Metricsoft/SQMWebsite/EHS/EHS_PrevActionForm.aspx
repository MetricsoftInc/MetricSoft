<%@ Page Title=""  Language="C#" MasterPageFile="~/RspPSMaster.Master"
	AutoEventWireup="True" EnableEventValidation="false" CodeBehind="EHS_PrevActionForm.aspx.cs" ClientIDMode="AutoID"
	Inherits="SQM.Website.EHS_PrevActionForm" ValidateRequest="false" %>

<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<%@ Register Src="~/Include/Ucl_AdminTabs.ascx" TagName="AdminTabs" TagPrefix="Ucl" %> 
<%@ Register Src="~/Include/Ucl_EHSPrevActionForm.ascx" TagName="ActionForm" TagPrefix="Ucl" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Body" runat="server">
	...
	<div class="pageWrapper">
		<div class="container-fluid tabActiveTableBg">
			<Ucl:ActionForm ID="uclActionForm" runat="server"/>
