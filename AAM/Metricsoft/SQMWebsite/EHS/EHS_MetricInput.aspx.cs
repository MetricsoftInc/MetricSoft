...
namespace SQM.Website
{
    public partial class EHS_MetricInput : SQMBasePage
    {
		...
		protected void lnkAddAttach(object sender, EventArgs e)
		{
			...
			uclAttachWin.OpenManageAttachmentsWindow(30, LocalProfile().Plant.PLANT_ID, LocalProfile().InputPeriod.PeriodYear.ToString() + "," + LocalProfile().InputPeriod.PeriodMonth.ToString(), "Upload Attachments", "Upload or view invoices or statements", PageUseMode.EditEnabled);
			BindSharedCalendars();
		}
