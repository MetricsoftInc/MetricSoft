            ...
            <td class="tabActiveTableBg" colspan="10" align="center">
                ...
                <FORM name="dummy">
                    ...
                    <span style="float: left; margin-left: 5px;" class="noprint">
						...
						<asp:LinkButton ID="lnkAttachments" runat="server" CssClass="buttonAttach" visible="false" Text="Attachments" ToolTip="Attachments" OnClick="lnkAddAttach"></asp:LinkButton>
