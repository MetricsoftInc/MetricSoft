        ...
        <div class="container-fluid tabActiveTableBg">
            ...
            <div id="divIncidentList" runat="server" visible="true">
                ...
                <div class="container-fluid summaryDataEnd" style="padding: 3px 4px 7px 0">
                    ...
                    <div class="row-fluid">
                        <span style="float: left; width: 160px;">
                            <asp:Label runat="server" ID="lblRecID" CssClass="prompt"></asp:Label>
                        </span>&nbsp;&nbsp;
									<br class="visible-xs-block" />
                        <telerik:RadNumericTextBox runat="server" ID="RTXT_RecID" Skin="Metro" Width="256px"
                            Type="Number"
                    ...
                    <div class="row" style="margin-top: 7px;">
                        ...
                        <span style="margin-top: 4px; margin-left: 14px;">
                            <span style="padding-right: 44px;">
                                <asp:Label runat="server" ID="lblIncidentDate" Text="Inspection From:" CssClass="prompt" meta:resourcekey="lblIncidentDateResource1"></asp:Label></span>
                            ...
                            <span style="margin-right: -10px !important;">
                                <telerik:RadDatePicker ID="dmFromDate" runat="server" CssClass="textStd" Width="115px" Height="21px" Skin="Metro" DateInput-Skin="Metro" DateInput-Font-Size="Small" Culture="en-US" meta:resourcekey="dmFromDateResource1">
                        ...
                        <span>
                            <span style="margin-left: 14px; padding-right: 8px;">
                                <asp:Label runat="server" ID="lblToDate" CssClass="prompt" Text="To" meta:resourcekey="lblToDateResource1"></asp:Label>
                        ...
                        <span class="noprint">
                            <span style="margin-left: 14px;">
                                ...
                                <span style="padding-top: 10px;">
                                    <asp:CheckBox ID="cbCreatedByMe" runat="server" meta:resourcekey="cbCreatedByMeResource1" /></span>
                                &nbsp;&nbsp;
                                ...
                                <span style="padding-top: 10px;">
                                    <asp:CheckBox ID="cbShowImage" runat="server" Visible="False" meta:resourcekey="cbShowImageResource1" /></span>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 text-left greyControlCol">
                        <telerik:RadComboBox ID="ddlActionLocation" runat="server" Skin="Metro" ZIndex="9000" Height="300px" Width="300px" Font-Size="Small"
                            ToolTip="Select the location where the inspection was conducted" EmptyMessage="select location" meta:resourcekey="ddlActionLocationResource1">
                        </telerik:RadComboBox>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 text-left greyControlCol">
                        <telerik:RadComboBox ID="rddlNewActionType" runat="server" Skin="Metro" ZIndex="9000" Height="250px" Width="300px" Font-Size="Small"
                            ToolTip="Select the type of Action you wish to report" EmptyMessage="select type" meta:resourcekey="rddlNewActionTypeResource1">
                        </telerik:RadComboBox>
                    </div>
                </div>
                <br />
