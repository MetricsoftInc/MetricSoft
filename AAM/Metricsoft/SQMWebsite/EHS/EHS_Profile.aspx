<%@ Page Title="" Language="C#" MasterPageFile="~/PSMaster.Master" AutoEventWireup="true" CodeBehind="EHS_Profile.aspx.cs" Inherits="SQM.Website.EHS_Profile" meta:resourcekey="PageResource1" %>
        ...
        <tr>
            <td class="tabActiveTableBg" colspan="10" align="center">
               ...
               <%-- <FORM name="dummy">--%>
                ...
                <asp:Panel runat="server" ID="pnlSearchBar" meta:resourcekey="pnlSearchBarResource1">
                ...
                <table width="100%">
			        <tr>
                        <td>
                            ...
                            <asp:Label ID="lblTitle" runat="server" Text="Metric Profile" Visible="False" meta:resourcekey="lblTitleResource1"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <div ID="divEHSProfile" runat="server" Visible = "false" >
                    ...
                    <asp:Panel id="pnlProfileEdit" runat="server" meta:resourcekey="pnlProfileEditResource1">
                        <table width="99.5%" align="center" border="0" cellspacing="0" cellpadding="1" class="borderSoft" style="margin-top: 2px;">
                            <tr>
                                ...
                                <td CLASS="tableDataAlt">
                                    <asp:DropDownList ID="ddlDisplayOrder" runat="server" CssClass="WarnIfChanged" onchange="ProfileChanged(this);" meta:resourcekey="ddlDisplayOrderResource1">
                            ...
                            <tr>
                                ...
                                <td CLASS="tableDataAlt">
                                        <asp:DropDownList ID="ddlDayDue" runat="server" CssClass="WarnIfChanged" onchange="ProfileChanged(this);" meta:resourcekey="ddlDayDueResource1"></asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td class="columnHeader">
                                ...
                                <td class="required">&nbsp;</td>
                                <td CLASS="tableDataAlt">
                                    <asp:DropDownList ID="ddlWarningDays" runat="server" CssClass="WarnIfChanged" onchange="ProfileChanged(this);" meta:resourcekey="ddlWarningDaysResource1"></asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td class="columnHeader">
                                ...
                                <td class="required">&nbsp;</td>
                                <td CLASS="tableDataAlt">
                                    <asp:DropDownList ID="ddlFinalApprover" runat="server" CssClass="WarnIfChanged" Width="250px" onchange="ProfileChanged(this);" meta:resourcekey="ddlFinalApproverResource1"></asp:DropDownList>
                                </td>
                            </tr>
                            <asp:PlaceHolder ID="phNormFact" runat="server">
                                <tr>
                                    ...
                                    <td CLASS="tableDataAlt">
                                        <asp:DropDownList ID="ddlNormFact" runat="server" CssClass="WarnIfChanged" meta:resourcekey="ddlNormFactResource1"></asp:DropDownList></asp:DropDownList>
                                    </td>
                                </tr>
                            </asp:PlaceHolder>
                        </table>
                        <span style="float: right; margin: 5px;">
                            <asp:Button ID="btnProfileCancel" CSSclass="buttonStd" runat="server" Text="<%$ Resources:LocalizedText, Cancel %>" OnClick="btnProfileCancel_Click" meta:resourcekey="btnProfileCancelResource1"  ></asp:Button>
                            <asp:Button ID="btnProfileSave" CSSclass="buttonEmphasis" runat="server" text="Save Profile"
                                                OnClientClick="return ValidProfile();" OnClick="btnProfileSave_Click" meta:resourcekey="btnProfileSaveResource1" ></asp:Button>
                        </span>
                    </asp:Panel>
                    ...
                    <telerik:RadWindow runat="server" ID="winMetricEdit" RestrictionZoneID="ContentTemplateZone" Skin="Metro" Modal="True" Height="460px" Width="750px" Title="User Preferences" Behaviors="Move" Behavior="Move" meta:resourcekey="winMetricEditResource1">
                        <ContentTemplate>
                            <asp:Panel id="pnlMetricEdit" style="margin-top: 10px;" runat="server" Visible="False" meta:resourcekey="pnlMetricEditResource1">
                                        ...
                                        <table width="99.5%" align="center" border="0" cellspacing="0" cellpadding="2" class="borderSoft" style="margin-top: 5px;">
                                            <tr>
                                                <td class="columnHeader" width="20%">
                                                    <asp:Label ID="lblMetricCode" runat="server" text="Metric" meta:resourcekey="lblMetricCodeResource1"></asp:Label>
                                                </td>
                                                <td class="required" width="1%">&nbsp;</td>
                                                <td CLASS="tableDataAlt" width="79%">
                                                    <asp:DropDownList ID="ddlMetricCategory" runat="server" CssClass="WarnIfChanged" OnSelectedIndexChanged="UpdateMain" AutoPostback="True" meta:resourcekey="ddlMetricCategoryResource1"></asp:DropDownList>
                                                    <br/>
							                        <span>
                                                        <asp:DropDownList ID="ddlMetricID" runat="server" CssClass="WarnIfChanged" OnSelectedIndexChanged="UpdateMain" AutoPostback="True" style="width: 400px; margin-top: 3px;" meta:resourcekey="ddlMetricIDResource1"></asp:DropDownList>
                                                        <asp:Label ID="lblMetricName" runat="server" CssClass="refText" meta:resourcekey="lblMetricNameResource1"></asp:Label>
							                        </span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="columnHeader">
                                                    <asp:Label ID="lblMetricStatus" runat="server" text="<%$ Resources:LocalizedText, Status %>" meta:resourcekey="lblMetricStatusResource1"></asp:Label>
                                                </td>
                                                <td class="tableDataAlt">&nbsp;</td>
                                                <td CLASS="tableDataAlt">
                                                    <asp:DropDownList ID="ddlMetricStatus" runat="server" CssClass="WarnIfChanged" onChange="MetricStatusChange();" meta:resourcekey="ddlMetricStatusResource1"></asp:DropDownList>
                                                    &nbsp;&nbsp;
                                                    ...
                                                    <asp:CheckBox id="cbMetricRequired" runat="server" CssClass="WarnIfChanged" meta:resourcekey="cbMetricRequiredResource1"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="columnHeader">
                                                    <asp:Label ID="lblMetricPrompt" runat="server" text="Display Prompt" meta:resourcekey="lblMetricPromptResource1"></asp:Label>
                                                </td>
                                                <td class="tableDataAlt">&nbsp;</td>
                                                <td class="tableDataAlt">
                                                    <asp:TextBox ID="tbMetricPrompt"  runat="server" TextMode="MultiLine" rows="1" MaxLength="200" CssClass="textStd WarnIfChanged" style="width: 97%;" meta:resourcekey="tbMetricPromptResource1"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="columnHeader">
                                                    <asp:Label ID="lblMetricResponsible" runat="server" text="Person Responsible" meta:resourcekey="lblMetricResponsibleResource1"></asp:Label>
                                                </td>
                                                <td class="required">&nbsp;</td>
                                                <td class="tableDataAlt">
                                                    <asp:DropDownList ID="ddlMetricResponsible" runat="server" CssClass="WarnIfChanged" Width="250px" meta:resourcekey="ddlMetricResponsibleResource1"></asp:DropDownList>
                                                </td>
                                            </tr>
                                            <asp:PlaceHolder ID="phCostWaste" runat="server">
                                                <tr>
                                                    ...
                                                    <td CLASS="tableDataAlt">
                                                        <asp:DropDownList ID="ddlMetricCost" runat="server" CssClass="WarnIfChanged" meta:resourcekey="ddlMetricCostResource1" ></asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="columnHeader">
                                                        <asp:Label ID="lblMetricCurrency" runat="server" text="Billing Currency" meta:resourcekey="lblMetricCurrencyResource1"></asp:Label>
                                                    <td id="tdCurrency" runat="server" class="required">&nbsp;</td>
                                                    <td CLASS="tableDataAlt">
                                                        <asp:DropDownList ID="ddlMetricCurrency" runat="server" CssClass="WarnIfChanged" meta:resourcekey="ddlMetricCurrencyResource1"></asp:DropDownList>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td class="columnHeader">
                                                        <asp:Label ID="lblMetricUOM" runat="server" text="Invoice UOM" meta:resourcekey="lblMetricUOMResource1"></asp:Label>
                                                    </td>
                                                    <td id="tdUOM" runat="server" class="tableDataAlt">&nbsp;</td>
                                                    <td CLASS="tableDataAlt">
                                                        <asp:DropDownList ID="ddlMetricUOM" runat="server" CssClass="WarnIfChanged" OnSelectedIndexChanged="ddlUOMChanged" AutoPostback="True" meta:resourcekey="ddlMetricUOMResource1"></asp:DropDownList>
                                                        <span id="spUOMFactor" runat="server" visible="False">
                                                            ...
                                                            <asp:TextBox ID="tbUOMFactor" runat="server" CssClass="textStd WarnIfChanged" maxlength="12" Columns="16" meta:resourcekey="tbUOMFactorResource1"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td CLASS="tableDataAlt" >
                                                        <div style="background-color: #e8e8e8; width: 98%; padding: 3px;">
                                                            ...
                                                            <asp:TextBox ID="tbValueDflt" runat="server" CssClass="textStd WarnIfChanged" maxlength="20" Columns="13" onblur="<%$ Resources:LocalizedText, NumericInputConfirm %>" meta:resourcekey="tbValueDfltResource1"></asp:TextBox>
                                                            &nbsp;
                                                            <asp:Label ID="lblCostDflt" runat="server" CssClass="prompt" text="Cost: " meta:resourcekey="lblCostDfltResource1"></asp:Label>
                                                            <asp:TextBox ID="tbCostDflt" runat="server" CssClass="textStd WarnIfChanged" maxlength="20" Columns="13" onblur="<%$ Resources:LocalizedText, NumericInputConfirm %>" meta:resourcekey="tbCostDfltResource1"></asp:TextBox>
                                                            &nbsp;
                                                            ...
                                                            <asp:CheckBox id="cbEnableOverride" runat="server" CssClass="WarnIfChanged" meta:resourcekey="cbEnableOverrideResource1"/>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </asp:PlaceHolder>
                                ...
                                <span style="float: right; margin: 5px;">
                                    <asp:Button ID="btnMetricCancel" CSSclass="buttonStd" runat="server" Text="<%$ Resources:LocalizedText, Cancel %>" enabled=False
                                        OnClick="btnMetricClear_Click" meta:resourcekey="btnMetricCancelResource1"></asp:Button>
                                    <asp:Button ID="btnMetricSave" CSSclass="buttonEmphasis" runat="server" text="Save Metric"
                                        OnClientClick="return MetricStatusConfirm();" OnClick="btnMetricSave_Click" meta:resourcekey="btnMetricSaveResource1"></asp:Button>
                                </span>
                                <br />
                                <center>
                                    <asp:Label ID="lblErrorMessage" runat="server" CssClass="labelEmphasis" meta:resourcekey="lblErrorMessageResource1"></asp:Label>
                                </center>
                            </asp:Panel>
                        </ContentTemplate>
                    </telerik:RadWindow>
                    ...
                    <div id="divMetricListGVScroll" runat="server" class="" style="width: 99.5%; margin-top: 10px;">
                        ...
                        <br style="clear: both;" />
                        <asp:GridView  runat="server" ID="gvMetricList" Name="gvMetricList" CssClass="Grid" ClientIDMode="AutoID" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" cellpadding="1" PageSize="20" AllowSorting="True" Width="100%" OnRowDataBound="gvOnProfileRowDataBound" meta:resourcekey="gvMetricListResource1">
                            <HeaderStyle CssClass="HeadingCellTextLeft" />
                            <RowStyle CssClass="DataCell" />
                	        <Columns>
                                <asp:TemplateField HeaderText="Metric" ItemStyle-Width="22%" meta:resourcekey="TemplateFieldResource1">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkMetricName" runat="server" CommandArgument='<%# Eval("PRMR_ID") %>' CSSClass="linkUnderline"
										        Text='<%# Eval("EHS_MEASURE.MEASURE_NAME") %>' OnClick="lnkMetricList_Click" meta:resourcekey="lnkMetricNameResource1"></asp:LinkButton>
                                        <asp:Label ID="lblMetricPrompt" runat="server" CssClass="refText" visible="False" meta:resourcekey="lblMetricPromptResource3"></asp:Label>
                                ...
                                <asp:TemplateField HeaderText="M Code" meta:resourcekey="TemplateFieldResource2">
							        <ItemTemplate>
								        ...
								        <asp:LinkButton ID="lnkMetricCD" runat="server" CommandArgument='<%# Eval("PRMR_ID") %>' CSSClass="linkUnderline"
										    Text='<%# Eval("EHS_MEASURE.MEASURE_CD") %>' OnClientClick="UpdateProfileButtons();" OnClick="lnkMetricList_Click" meta:resourcekey="lnkMetricCDResource1"></asp:LinkButton>
                                    </ItemTemplate>
							    </asp:TemplateField>
                                <asp:TemplateField HeaderText="" ItemStyle-Width="22px" ItemStyle-HorizontalAlign=Center meta:resourcekey="TemplateFieldResource3">
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField id="hfDisposalCode" runat="server" value='<%# Eval("UN_CODE") %>' />
                                            <asp:Image ID="imgHazardType" ToolTip="Energy input" runat="server" style="vertical-align: middle;" meta:resourcekey="imgHazardTypeResource1"/>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Reqd" ItemStyle-HorizontalAlign=Center meta:resourcekey="TemplateFieldResource4">
                                    <ItemTemplate>
                                        ...
                                        <asp:CheckBox id="cbMetricRequired" runat="server" Enabled="False" meta:resourcekey="cbMetricRequiredResource3"/>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                                ...
                                <asp:TemplateField HeaderText="Responsible" meta:resourcekey="TemplateFieldResource5">
                                    <ItemTemplate>
                                        <asp:Label ID="lblMetricResponsible" runat="server" Text='<%# Eval("PERSON.LAST_NAME",Eval("PERSON.FIRST_NAME","{0}")+" {0}") %>' meta:resourcekey="lblMetricResponsibleResource3"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Invoice Type" meta:resourcekey="TemplateFieldResource6">
                                    <ItemTemplate>
                                        <asp:Label ID="lblInvoiceType" runat="server" Text='<%# Eval("NEG_VALUE_ALLOWED") %>' meta:resourcekey="lblInvoiceTypeResource1"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Currency" meta:resourcekey="TemplateFieldResource7">
                                    <ItemTemplate>
                                        <asp:Label ID="lblCurrency" runat="server" Text='<%# Eval("DEFAULT_CURRENCY_CODE") %>' meta:resourcekey="lblCurrencyResource1"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Invoice UOM" meta:resourcekey="TemplateFieldResource8">
                                    <ItemTemplate>
                                        <asp:Label ID="lblInvoiceUOM" runat="server" Text='<%# Eval("DEFAULT_UOM") %>' meta:resourcekey="lblInvoiceUOMResource1"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="UN Code" meta:resourcekey="TemplateFieldResource9">
                                    <ItemTemplate>
                                        <asp:Label ID="lblUNCode" runat="server" Text='<%# Eval("UN_CODE") %>' meta:resourcekey="lblUNCodeResource1"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Waste Code" meta:resourcekey="TemplateFieldResource10">
                                    <ItemTemplate>
                                        <asp:Label ID="lblWasteCode" runat="server" Text='<%# Eval("WASTE_CODE") %>' meta:resourcekey="lblWasteCodeResource1"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                        <asp:Label runat="server" ID="lblMetricListEmpty" Text="There are currently no Metrics defined for this business location." class="GridEmpty" Visible="False" meta:resourcekey="lblMetricListEmptyResource1"></asp:Label>
                    </div>
                </div>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Panel ID="pnlCopyProfile" runat="server" style="float: left; margin-left: 15px;" Visible="False" meta:resourcekey="pnlCopyProfileResource1">
