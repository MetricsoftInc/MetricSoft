                ...
                <div class="container-fluid summaryDataEnd" style="padding: 3px 4px 7px 0">
                    ...
                    <asp:PlaceHolder ID="phAudit" runat="server">
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="row-fluid">
                                <span style="float: left; width: 160px;">
                                    <asp:Label runat="server" ID="lblAssessmentID" CssClass="prompt"></asp:Label>
                                </span>&nbsp;&nbsp;
									<br class="visible-xs-block" />
                                   <telerik:RadNumericTextBox runat="server" ID="RTXT_AssessmentID" ClientEvents-OnKeyPress="keyPress" Skin="Metro" Width="256px" 
                                Type="Number" 
