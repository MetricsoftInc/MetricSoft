            ...
            <tr>
                <td class="tabActiveTableBg">
                    <div class="noprint" style="float: left;">
                        <asp:Label ID="lblViewEHSRezTitle" runat="server" CssClass="pageTitles" Text="Manage Environmental Health &amp; Safety Audits"></asp:Label><br />
                        <asp:Label ID="lblPageInstructions" runat="server" CssClass="instructText" Text="Add or update EH&amp;S Audits below."></asp:Label>
                    </div>
                    ...
                    <div id="divAuditList" runat="server" visible="true">
                        <table cellspacing="0" cellpadding="1" border="0" width="100%" style="margin-bottom: 2px;">
                            <tr>
