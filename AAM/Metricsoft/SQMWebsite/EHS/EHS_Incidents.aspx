            ...
            <div id="divIncidentList" runat="server" visible="true">
                ...
                <div class="container-fluid summaryDataEnd" style="padding: 3px 4px 7px 0">
                    ...
                    <asp:PlaceHolder ID="phIncident" runat="server">
                        ...
                        <div class="row-fluid">
                            <span style="float: left; width: 160px;">
                                <asp:Label runat="server" ID="lblIncidentID" CssClass="prompt" Text="Incident ID"></asp:Label>
                            </span>&nbsp;&nbsp;
									<br class="visible-xs-block" />
                            ...
                            <telerik:RadNumericTextBox runat="server" ID="RTXT_IncidentID" ClientEvents-OnKeyPress="keyPress" Skin="Metro" Width="256px" 
                                Type="Number" 
                                NumberFormat-AllowRounding="False" 
                                NumberFormat-GroupSeparator=""></telerik:RadNumericTextBox>

                            <%-- <telerik:RadTextBox ID="RTXT_IncidentID" Skin="Metro" Width="256px" runat="server">
                    ...
                    <div class="row" style="margin-top: 7px;">
                        ...
                        <span style="margin-top: 4px; margin-left: 14px;">
                            <span style="padding-right: 44px;">
                                <asp:Label runat="server" ID="lblIncidentDate" Text="Incident Date From:" CssClass="prompt" meta:resourcekey="lblIncidentDateResource1"></asp:Label></span>
                            ...
                            <span style="margin-right: -10px !important;">
                                <telerik:RadDatePicker ID="dmFromDate" runat="server" CssClass="textStd" Width="115px" Height="21px" Skin="Metro" DateInput-Skin="Metro" DateInput-Font-Size="Small">
                        ...
                        <span class="noprint">
                            <span style="margin-left: 14px;">
                                ...
                                <span style="padding-top: 10px;">
                                    <asp:CheckBox ID="cbCreatedByMe" runat="server" /></span>
                                &nbsp;&nbsp;
                                ...
                                <span style="padding-top: 10px;">
                                    <asp:CheckBox ID="cbShowImage" runat="server" Visible="False" /></span>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 text-left greyControlCol">
                        <telerik:RadComboBox ID="ddlIncidentLocation" runat="server" Skin="Metro" ZIndex="9000" Height="300px" Width="300px" Font-Size="Small"
                            ToolTip="Select the location where the incident occured" EmptyMessage="<%$ Resources:LocalizedText, Select %>">
                        </telerik:RadComboBox>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 text-left greyControlCol">
                        <telerik:RadComboBox ID="rddlNewIncidentType" runat="server" Skin="Metro" ZIndex="9000" Height="250px" Width="300px" Font-Size="Small"
                            ToolTip="Select the type of incident you wish to report" EmptyMessage="<%$ Resources:LocalizedText, Select %>">
                        </telerik:RadComboBox>
                    </div>
                </div>
                <br />
