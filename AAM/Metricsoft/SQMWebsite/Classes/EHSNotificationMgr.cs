        ...
        public static int NotifyIncidentAlertTaskAssignment(INCIDENT incident, List<TASK_STATUS> taskList)
        {
            ...
            foreach (TASK_STATUS task in taskList)
            {
                ...
                emailBody += "<br/>" +
                                "Incident ID: " + WebSiteCommon.FormatID(incident.INCIDENT_ID, 6) + "<br/>" +
                                incident.DESCRIPTION + "<br/>" +
                                "Recorded By : " + incident.LAST_UPD_BY + "<br/>" +
                                SQMBasePage.GetXLAT(XLATList, "NOTIFY_TASK_ASSIGN", "ALERT_02", lang.NLS_LANGUAGE).DESCRIPTION + "<br>"+
                                "Affected Processes: " + task.DESCRIPTION + "<br>" +
                                "Implementation Recommendations: " + task.DETAIL + "<br>" +
                                "Please follow the instructions below to complete this request." + "<br/>" +
                                "1)Access <b style='color:navy'>“Calendar View”</b> in the NSK Risk Management Portal." + "<br/>" +
                                "2)Click the blue button<b style='color:navy'> “Actions Assigned”</b>." + "<br/>" +
                                "3)Select <b style='color:navy'>“Display Tasks”</b> for your name, or your plant." + "<br/>" +
                                "4) Under<b style='color:navy'> “Type”</b> look for Preventative Action – Action Required." + "<br/>" +
                                "5) Find and click on the corresponding <b style='color:navy'>“Task ID”</b>." + "<br/>" +
                                "6)Add Comments in the provided field and select <b style='color:navy'>“Save”</b>." + "<br/>" +
                                "<br/>Thank You<br/>" +
                                SQMBasePage.GetXLAT(XLATList, "INCIDENT_NOTIFY", "ALERT_04", lang.NLS_LANGUAGE).DESCRIPTION+ "<br/>" +
