		...
		<asp:Panel runat="server" ID="pnlLogin">
			...
			<div class="row-fluid">
				...
				<div class="col-xs-12 text-left">
					...
					<telerik:RadButton ID="btnLogin" runat="server" meta:resourcekey="btnLoginResource1" CssClass="rbEmphasis" text="Login" Skin="Metro" Style="width: 85px;  margin: 5px 10px 0 5px;"
