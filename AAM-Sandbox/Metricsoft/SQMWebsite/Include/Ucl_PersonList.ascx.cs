...
{
	public delegate void PersonDataClick(PERSON person);
	//public delegate void PartDataClick(PartData part);

	public partial class Ucl_PersonList : System.Web.UI.UserControl
	{

		public event GridItemClick OnPersonClick;
		//public event PartDataClick OnPartDataClick;
		public event GridItemClick OnPersonListCloseClick;
		//public event PersonDataClick OnPersonDataClick;
		//public event GridItemClick OnPersonListCloseClick;
		...
		protected void lnkPerson_Click(object sender, EventArgs e)
		{
			if (OnPersonClick != null)
			{
				LinkButton lnk = (LinkButton)sender;
				OnPersonClick(Convert.ToDecimal(lnk.CommandArgument.ToString().Trim()));
			}
		}
		...
		protected void lnkPartList_Click(object sender, EventArgs e)
		{
			...
			//{
				if (OnPersonClick != null)
				{
					// $$$$ OnPersonClick(part.Part.PART_ID);
				}
				//if (OnPersonDataClick != null)
				//{
				//	OnPersonDataClick(part);
				//}
			//}
		}
		protected void btnPartListClose_Click(object sender, EventArgs e)
		{
			if (OnPersonListCloseClick != null)
			{
				OnPersonListCloseClick(0);
			}
		}

		public void BindPersonList(List<PersonData> theList)
		{
			if (theList != null)
			{


				//ToggleVisible(pnlPersonList);
				pnlPersonList.Visible = true;
				gvPersonList.DataSource = theList;
				gvPersonList.DataBind();
				SetGridViewDisplay(gvPersonList, lblPartListEmpty, divPartListScroll, 50, 0);
			}
			else
			{
				//ToggleVisible(null);
		...
		//public void gvPersonList(object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
		//{
		//	if ((!e.Row.RowType.ToString().Trim().Equals(System.Web.UI.WebControls.ListItemType.Header.ToString())) & (!e.Row.RowType.ToString().Trim().Equals(System.Web.UI.WebControls.ListItemType.Footer.ToString())))
		//	{
		...
		public void gvPersonList_OnRowDataBound(object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
		{
			if ((!e.Row.RowType.ToString().Trim().Equals(System.Web.UI.WebControls.ListItemType.Header.ToString())) & (!e.Row.RowType.ToString().Trim().Equals(System.Web.UI.WebControls.ListItemType.Footer.ToString())))
			{
