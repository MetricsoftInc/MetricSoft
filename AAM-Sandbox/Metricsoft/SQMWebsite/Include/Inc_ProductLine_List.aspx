					                    ...
					                    <table cellpadding=0 cellspacing=2 border=0>
						                    <tr>
							                    <td>
                                                 ...
                                                 <td>
                                                    <asp:Button ID="lbProdLineSave1" CSSclass="buttonEmphasis" runat="server" text="Save" OnClientClick="return confirmChange('Product Lines');" onclick="lbSaveProdLineList_Click"></asp:Button>
                                                </td>
						                    </tr>
					                    </table>
				                    </td>
			  	                    ...
			  	                    <td align=right>
					                    <table cellpadding=0 cellspacing=2 border=0>
						                    <tr>
                                                ...
                                                <td>
                                                    <asp:Button ID="lbProdLineSave2" CSSclass="buttonEmphasis" runat="server" text="Save"  OnClientClick="return Validate_ProductLineList();" onclick="lbSaveProdLineList_Click" CausesValidation="true"></asp:Button>
                                                </td>
						                    </tr>
					                    </table>
				                    </td>
